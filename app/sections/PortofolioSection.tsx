...
const PROJECTS: Project[] = [
  { num: "01", year: "2025", title: "Retach", shortDesc: "Platform digital berbasis web untuk refleksi pembelajaran Guru menggunakan metode Gibbs.", fullDesc: "Menyediakan platform digital berbasis web bagi Guru untuk mendokumentasikan refleksi pembelajaran setelah kelas selesai (menggunakan metode Gibbs) dan mengunduh hasilnya menjadi PDF siap cetak untuk portofolio administrasi (SKP/PMM). Platform ini juga dilengkapi dengan akses Admin langsung (tanpa visual dashboard) untuk manajemen akun guru dan pemantauan kelengkapan dokumen demi kebutuhan supervisi sekolah.", tags: ["Laravel", "TailwindCSS", "MySQL"], href: "https://retach.my.id", github: "https://github.com/nolanhakim/website-refleksi_retech.git", image: "/img/retach.png" },
  ...
  { num: "10", year: "2026", title: "Smart Compost Village", shortDesc: "Aplikasi web non-IoT pendukung digitalisasi pengelolaan sampah organik desa.", fullDesc: "Aplikasi web pendukung berbasis non-IoT yang dirancang untuk memfasilitasi program digitalisasi pengelolaan sampah organik mandiri di tingkat pedesaan. Sistem ini mendampingi penggunaan fisik mesin komposter otomatis berbasis timer relay.", tags: ["Laravel", "TailwindCSS", "MySQL", "SMTP"], href: "http://smart-compostvillage.my.id", github: "https://github.com/nolanhakim/Smart-Compost-Village.git", image: "/img/compost.png" },
];
